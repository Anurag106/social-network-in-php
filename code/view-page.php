                    ...
                    ?>
                      ...
                      <div class="box box-widget">
                        ...
                        ?>
                          ...
                          $sql1 = "SELECT * FROM page_likes WHERE id_user='$_SESSION[id_user]' AND id_post='$row[id_page]'";
                          $result1 = $conn->query($sql1);
                          ...
                          if($result1->num_rows > 0) {
                            ...
                            ?>
                               <button type="button" id="addLike" data-id="<?php echo $row['id_page']; ?>" class="btn btn-default btn-xs"><i class="fa fa-thumbs-o-up"></i> Like</button>
                            <?php
                          }
                          ?>   
                          <?php
                          $sql2 = "SELECT * FROM page_likes WHERE id_post='$row[id_page]'";
                          $result2 = $conn->query($sql2);
                          $totalLikes = (int)$result2->num_rows; 
                          ?>  
                          <?php
                          $sql3 = "SELECT * FROM page_comments WHERE id_post='$row[id_page]'";
                        ...
                        <!-- /.box-body -->
                        <?php
                        $sql4 = "SELECT * FROM page_comments WHERE id_post='$row[id_page]'";
                        ...
                        <?php
                            ...
                            while($row4 = $result4->fetch_assoc()) {
                              $sql5 = "SELECT * FROM users WHERE id_user='$row[id_user]'";
